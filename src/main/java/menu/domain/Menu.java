...
public enum Menu {
    ...
    Menu(String menuStyle, List <String> kinds) {
        this.menuStyle = menuStyle;
        this.kinds = kinds;
    }

    public String getMenu(String menuStyle){
        List<String> menus = Arrays.stream(values())
                .filter(menu -> menu.menuStyle.equals(menuStyle))
                .findFirst()
                .orElseThrow(() -> new IllegalArgumentException("원하시는 스타일이 존재하지 않습니다."))
                .kinds;
